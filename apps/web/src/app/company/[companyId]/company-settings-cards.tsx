// Company settings cards: UPI scan-to-pay details and the invoice print
// layout editor. (Branch management is not part of this build — a single
// business, a single location.)
'use client';
